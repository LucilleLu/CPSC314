...
var skybox = { type: "t", value: skyboxCubemap };
...
var shaderFiles = [
  ...
  'glsl/envirmap.vs.glsl',
  'glsl/envirmap.fs.glsl',
...
new THREE.SourceLoader().load(shaderFiles, function(shaders) {
	...
	armadilloMaterial.vertexShader = shaders['glsl/envirmap.vs.glsl']
	armadilloMaterial.fragmentShader = shaders['glsl/envirmap.fs.glsl']
...
var sphere = new THREE.Mesh(sphereGeometry, armadilloMaterial);
sphere.position.set(0,1.5,-1.5)
