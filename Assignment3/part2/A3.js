...
var hatchingMaterial = new THREE.ShaderMaterial({
  uniforms: {
    ightColor: lightColorUniform,
    ambientColor: ambientColorUniform,
    lightDirection: lightDirectionUniform,
...
var shaderFiles = [
  ...
  'glsl/toon.fs.glsl',
  'glsl/toon.vs.glsl',  
  'glsl/hatching.fs.glsl',
  'glsl/hatching.vs.glsl',
...
new THREE.SourceLoader().load(shaderFiles, function(shaders) {
  ...
  hatchingMaterial.fragmentShader = shaders['glsl/hatching.fs.glsl'];
  hatchingMaterial.vertexShader = shaders['glsl/hatching.vs.glsl'];


  phongMaterial.needsUpdate = true;
  bPhongMaterial.needsUpdate = true;
  toonMaterial.needsUpdate = true;
  hatchingMaterial.needsUpdate = true;
})
...
hatching.sphere = new THREE.SphereGeometry(1, 16, 16);
hatching.npr_hatching = new THREE.Mesh(hatching.sphere, hatchingMaterial);
hatching.npr_hatching.position.set(0, 1, 1);
scenes[Part.HATCHING].add(hatching.npr_hatching);

loadOBJ(Part.HATCHING,'obj/armadillo.obj',hatchingMaterial, 1.8, 4,1.9,5,0,0,0);
loadOBJ(Part.HATCHING,'obj/bunny.obj',hatchingMaterial, 0.4, -2,0.1,3,0,0,0);
loadOBJ(Part.HATCHING,'obj/car.obj',hatchingMaterial, 0.04, -3.4,0,-2,-1.57,0,0);
loadOBJ(Part.HATCHING,'obj/male.obj',hatchingMaterial, 0.03, 1.3,0,-2.5,0,0,0);
...
loadOBJ(Part.TOON,'obj/armadillo.obj',toonMaterial, 1.8, 4,1.9,5,0,0,0);
loadOBJ(Part.TOON,'obj/bunny.obj',toonMaterial, 0.4, -2,0.1,3,0,0,0);
loadOBJ(Part.TOON,'obj/car.obj',toonMaterial, 0.04, -3.4,0,-2,-1.57,0,0);
loadOBJ(Part.TOON,'obj/male.obj',toonMaterial, 0.03, 1.3,0,-2.5,0,0,0);
